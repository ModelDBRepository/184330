'''
Current clamp demo using Allen Brain's model 473862845.
...
from neuron473862845 import Neuron473862845
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron473862845(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 473862845; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-87.2847976685)
        h.fcurrent()
